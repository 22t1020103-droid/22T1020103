...
namespace SV22T1020103.DataLayers.SQLServer
{
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public async Task<bool> ChangePasswordAsync(int customerID, string oldPassword, string newPassword)
        {
            ...
            int rows = await connection.ExecuteAsync(sql, new { customerID, oldPassword, newPassword });
            return rows > 0;
        }
        ...
        public async Task<bool> SetPasswordAsync(int customerID, string newPassword)
        {
            ...
            int rows = await connection.ExecuteAsync(sql, new { customerID, newPassword });
            return rows > 0;
        }
